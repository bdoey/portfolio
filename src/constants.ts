...
export const SKILLS: SkillGroup[] = [
    ...
    },
    {
        ...
        skills: [
            {name: 'Google Cloud Platform (GCP)', icon: 'fab fa-google', description: 'Google Cloud Platform is a comprehensive suite of cloud computing services for building, deploying, and scaling applications. It offers infrastructure, storage, machine learning, and data analytics services used by enterprises worldwide. GCP\'s integration with Google\'s AI/ML tools makes it particularly strong for data science and machine learning workloads.'},
            ...
            {name: 'Jenkins CI/CD', icon: 'fab fa-jenkins', description: 'Jenkins is an open-source automation server for implementing continuous integration and continuous delivery pipelines. It supports building, testing, and deploying software with extensive plugin ecosystem. Jenkins is used in MLOps for automating model training, testing, and deployment workflows in production environments.'},
