...
const Header: React.FC = () => {
  return (
    <header className="relative flex flex-col items-center text-center max-w-full p-4 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-sky-900/20 via-transparent to-purple-900/20 animate-gradient bg-[length:200%_200%]"></div>

      {/* Floating orbs for visual interest */}
      <div className="absolute top-10 left-10 w-32 h-32 bg-sky-500/10 rounded-full blur-3xl animate-float"></div>
      <div className="absolute bottom-10 right-10 w-40 h-40 bg-purple-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
